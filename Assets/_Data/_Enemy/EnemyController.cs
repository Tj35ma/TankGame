...
public abstract class EnemyController : PoolObj
{
    ...
    [SerializeField] protected TurretTargetable turretTargetable;
    public TurretTargetable TurretTargetable => turretTargetable;
    ...
    {
        if (this.turretTargetable != null) return;
        this.turretTargetable = GetComponentInChildren<TurretTargetable>();
        Debug.Log(transform.name + ": LoadTurretTargetable", gameObject);
    }
